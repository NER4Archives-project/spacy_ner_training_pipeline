"""
This code is adapted from https://github.com/explosion/spacy-huggingface-hub
"""
...
def push(
    ...
    commit_msg = "Update spaCy pipeline"
    silent = False
    verbose = True
...
if __name__ == "__main__":
    typer.run(push)
    #push(whl_path="../packages/fr_ner4archives_v3_default-0.0.0/dist/fr_ner4archives_v3_default-0.0.0-py3-none-any.whl",
    #     namespace="ner4archives",
    #     commit_msg="Update spaCy pipeline")
